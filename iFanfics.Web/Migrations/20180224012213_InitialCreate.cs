        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifyingDate = table.Column<DateTime>(nullable: false),
                    PictureURL = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FanficId = table.Column<string>(nullable: true),
                    Title = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FanficsTags", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChaptersRating", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChaptersRating_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChaptersRating_Chapters_ChapterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentsRating", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentsRating_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CommentsRating_Comments_CommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChaptersRating_ApplicationUserId",
                table: "ChaptersRating",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChaptersRating_ChapterId",
                table: "ChaptersRating",
                column: "ChapterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentsRating_ApplicationUserId",
                table: "CommentsRating",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentsRating_CommentId",
                table: "CommentsRating",
                column: "CommentId");
